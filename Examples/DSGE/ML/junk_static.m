function [residual, g1, g2, g3] = junk_static(y, x, params)
%
...
T28 = params(1)*exp(y(6))*y(3)^(params(1)-1);
T31 = y(4)^(1-params(1));
T36 = y(3)^params(1);
T39 = y(4)^(-params(1));
lhs =y(8);
...
residual(3)= lhs-rhs;
lhs =y(11);
rhs =exp(y(6))*(1-params(1))*T36*T39;
residual(4)= lhs-rhs;
lhs =y(8);
...
T82 = getPowerDeriv(y(3),params(1),1);
T90 = getPowerDeriv(y(4),1-params(1),1);
  ...
  g1(3,6)=(-(T28*T31));
  g1(3,10)=1;
  g1(4,3)=(-(T39*exp(y(6))*(1-params(1))*T82));
  g1(4,4)=(-(exp(y(6))*(1-params(1))*T36*getPowerDeriv(y(4),(-params(1)),1)));
  g1(4,6)=(-(exp(y(6))*(1-params(1))*T36*T39));
  g1(4,11)=1;
  ...
  g1(8,7)=1-params(8);
  g1(9,1)=1;
  g1(9,3)=(-(T31*exp(y(6))*T82));
  g1(9,4)=(-(exp(y(6))*T36*T90));
  g1(9,6)=(-(T31*exp(y(6))*T36));
  g1(10,1)=(-1);
  g1(10,2)=1;
  g1(10,5)=1;
