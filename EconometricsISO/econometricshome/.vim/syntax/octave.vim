...
" Original Maintainers: Francisco Castro <fcr@adinet.com.uy>
" 			Preben 'Peppe' Guldberg <peppe-vim@wielders.org>
" Original Author: Mario Eusebio
" Last Change:	20 Mar 2008
...
syn keyword octaveBeginKeywords for function if switch try unwind_protect while do
...
syn keyword octaveEndKeywords  end_try_catch end_unwind_protect endwhile until
...
syn keyword octaveFunction fftfilt fftshift figure fileparts find findstr
syn keyword octaveFunction f_inv fir2sys flipdim fliplr flipud flops f_pdf
...
syn keyword octaveFunction interp1 interp2 interpn interpft
...
syn keyword octaveFunction kolmogorov_smirnov_test_2 kron kruskal_wallis_test
...
syn keyword octaveFunction lookup lqr lsim ltifr lyap max mahalanobis manova
syn keyword octaveFunction mcnemar_test mean meansq median menu mesh meshdom
syn keyword octaveFunction meshdom meshgrid min minfo mod moddemo moment mplot
