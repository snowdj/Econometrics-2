...
set shiftwidth=2
" Folding - uncomment to enable
"let fortran_fold=1
"let fortran_fold_multilinecomments=1
"set foldmethod=syntax
"set foldlevel=1

" Converts an allocate statement into a deallocate statement
command! Deallocate s/allocate/deallocate/g | s/(\(\i\|\s\|,\)\+)//g
" Instantiate a template
command! Instantiate pyfile $HOME/.vim/ftplugin/templ.py
" Delete instance
command! DelInstance .+1,/END INSTANCE/d
" vim:sw=2
" get stubs plugin
runtime! ftplugin/fortran_stubs.vim
